...
public class TransCoord {
	...
	public static CoordPoint getTransCoord(CoordPoint inPoint, int fromType, int toType) {
		return convertCoord(inPoint, fromType, toType, COORD_BASE[fromType][0], COORD_BASE[fromType][1], COORD_BASE[toType][0],
				COORD_BASE[toType][1]);
	}

	private static CoordPoint convertCoord(CoordPoint point, int fromType, int toType, double frombx, double fromby, double tobx,
			double toby) {
	...
	private static final int COORD_BASE[][] = { new int[2], { 127, 38 }, { -1, -1 }, { 129, 0 }, { -1, -1 }, { -1, -1 }, { -1, -1 },

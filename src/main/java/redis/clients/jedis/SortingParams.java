...
public class SortingParams {
	 ...
	 * <p>
	 * Takes a pattern that is used in order to generate the key names of the weights used for sorting. Weight key names are obtained
	 * substituting the first occurrence of * with the actual value of the elements on the list.
	 * <p>
	 ...
	 * No sorting.
	 * <p>
	 * This is useful if you want to retrieve a external key (using {@link #get(String...) GET}) but you don't want the sorting overhead.
	 * 
	 * @return the SortingParams Object
	 */
	 ...
	 * <p>
	 * Takes a pattern that is used in order to generate the key names of the result of sorting. The key names are obtained substituting the

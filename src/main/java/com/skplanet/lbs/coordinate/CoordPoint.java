// LBS Guide, http://hyosang.kr/269

package com.skplanet.lbs.coordinate;
...
public class CoordPoint {
	...
	public void convertBESSEL2WGS() {
		setParameter(115.8D, -474.99000000000001D, -674.11000000000001D, 1.1599999999999999D, -2.3100000000000001D, -1.6299999999999999D,
				-6.4299999999999997D, 1.0D);
	...
	private void GP2TM(double d, double e, double h, double g, double j, double l, double m) {
		...
		J = (G * H * Math.pow(u, 5D) * j * (((((((61D - 58D * Math.pow(A, 2D)) + Math.pow(A, 4D) + 270D * w) - 330D * Math.pow(A, 2D) * w)
				+ 445D * Math.pow(w, 2D) + 324D * Math.pow(w, 3D)) - 680D * Math.pow(A, 2D) * Math.pow(w, 2D)) + 88D * Math.pow(w, 4D))
				- 600D * Math.pow(A, 2D) * Math.pow(w, 3D) - 192D * Math.pow(A, 2D) * Math.pow(w, 4D))) / 720D;
		...
		w = (G * Math.pow(u, 5D) * j * (((((5D - 18D * Math.pow(A, 2D)) + Math.pow(A, 4D) + 14D * w) - 58D * Math.pow(A, 2D) * w) + 13D
				* Math.pow(w, 2D) + 4D * Math.pow(w, 3D))
				- 64D * Math.pow(A, 2D) * Math.pow(w, 2D) - 25D * Math.pow(A, 2D) * Math.pow(w, 3D))) / 120D;
	...
	private void TM2GP(double d, double e, double h, double g, double j, double l, double m) {
		...
		I = (E * ((5D + 3D * Math.pow(E, 2D) + u) - 4D * Math.pow(u, 2D) - 9D * Math.pow(E, 2D) * u))
				/ (24D * H * Math.pow(G, 3D) * Math.pow(j, 4D));
		J = (E * ((((((61D + 90D * Math.pow(E, 2D) + 46D * u + 45D * Math.pow(E, 4D)) - 252D * Math.pow(E, 2D) * u - 3D * Math.pow(u, 2D)) + 100D * Math
				.pow(u, 3D)) - 66D * Math.pow(E, 2D) * Math.pow(u, 2D) - 90D * Math.pow(E, 4D) * u)
				+ 88D * Math.pow(u, 4D) + 225D * Math.pow(E, 4D) * Math.pow(u, 2D) + 84D * Math.pow(E, 2D) * Math.pow(u, 3D)) - 192D
				* Math.pow(E, 2D) * Math.pow(u, 4D)))
				/ (720D * H * Math.pow(G, 5D) * Math.pow(j, 6D));
		H = (E * (1385D + 3633D * Math.pow(E, 2D) + 4095D * Math.pow(E, 4D) + 1575D * Math.pow(E, 6D)))
				/ (40320D * H * Math.pow(G, 7D) * Math.pow(j, 8D));
		...
		u = (((((5D + 6D * u + 28D * Math.pow(E, 2D)) - 3D * Math.pow(u, 2D)) + 8D * Math.pow(E, 2D) * u + 24D * Math.pow(E, 4D)) - 4D * Math
				.pow(u, 3D)) + 4D * Math.pow(E, 2D) * Math.pow(u, 2D) + 24D * Math.pow(E, 2D) * Math.pow(u, 3D))
				/ (120D * Math.pow(G, 5D) * z * Math.pow(j, 5D));
		z = (61D + 662D * Math.pow(E, 2D) + 1320D * Math.pow(E, 4D) + 720D * Math.pow(E, 6D))
				/ (5040D * Math.pow(G, 7D) * z * Math.pow(j, 7D));
	...
	private void shiftIsland(boolean d) {
		...
		if (d) {
			for (int i = 0; i < rectArray1.length; i++) {
				if (this.x - rectArray1[i].x < 0.0D || this.x - rectArray1[i].x > rectArray1[i].w || this.y - rectArray1[i].y < 0.0D
			...
			y = this.y / 2.5D;
			for (int i = 0; i < rectArray2.length; i++) {
				if (x - rectArray2[i].x < 0.0D || x - rectArray2[i].x > rectArray2[i].w || y - rectArray2[i].y < 0.0D
						|| y - rectArray2[i].y > rectArray2[i].h)
					continue;
				x += deltaValue2[i][0];
				y += deltaValue2[i][1];
				break;
	...
	private final CoordRect rectArray1[] = { new CoordRect(112500D, -50000D, 33500D, 53000D),
			new CoordRect(146000D, -50000D, 54000D, 58600D), new CoordRect(130000D, 44000D, 15000D, 14000D),
			new CoordRect(532500D, 437500D, 25000D, 25000D), new CoordRect(625000D, 412500D, 25000D, 25000D),
			new CoordRect(-12500D, 462500D, 17500D, 50000D) };
	private final CoordRect rectArray2[] = { new CoordRect(112500D, -50000D, 33500D, 53000D),
			new CoordRect(146000D, -50000D, 54000D, 58600D), new CoordRect(130000D, 44000D, 15000D, 14000D),
			new CoordRect(532500D, 437500D, 25000D, 25000D), new CoordRect(625000D, 412500D, 25000D, 25000D),
			new CoordRect(-12500D, 462500D, 17500D, 50000D) };
	private double deltaValue1[][] = { { 0.0D, 50000D }, { 0.0D, 50000D }, { 0.0D, 10000D }, { -70378D, -136D }, { -144738D, -2161D },
			{ 23510D, -111D } };
	private double deltaValue2[][] = { { 0.0D, -50000D }, { 0.0D, -50000D }, { 0.0D, -10000D }, { 70378D, 136D }, { 144738D, 2161D },
			{ -23510D, 111D } };
}
